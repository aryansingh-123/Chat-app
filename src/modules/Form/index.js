...
const Form = (
    ...
    return (
        <div className="bg-gray-200 w-[400px] h-[450px] shadow-lg hover:shadow-gray-900 shadow-gray-500 rounded-lg flex flex-col justify-center item-center">
           ...
           <div className="text-sm flex justify-center item-center">{ isSignInPage ? "Didn't have an account?" : "Already have an Account?"} <span className="text-blue-700 cursor-pointer underline" >{isSignInPage ? 'Sign Up' :'Sign In'} </span></div>
        </div>
    )
}
